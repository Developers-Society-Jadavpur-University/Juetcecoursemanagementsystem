...
$sql = "INSERT INTO batch_info(course_code,course_name,department,faculty,start_year,end_year,status_course ) values('$course_code','$course_name','$department','$faculty','$start_year','$end_year','1')";
